        ...
        <div className="min-h-screen flex items-center justify-center bg-black relative">
            ...
            <div className="relative z-10 w-full max-w-md p-8 md:p-12 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl">
                ...
                <div className="text-center space-y-2 mb-10">
                    ...
                    <p className="text-white/60 text-sm font-light">Sign in to manage your luxury portfolio.</p>
                </div>
                ...
                <div className="text-center mt-8">
                    <p className="text-sm text-white/50 font-light">
                        New here? <Link to="/admin/register" className="text-white font-medium hover:underline decoration-white/50 underline-offset-4">Create an account</Link>
                    </p>
                </div>
